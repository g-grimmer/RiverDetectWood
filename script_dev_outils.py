...
command = [
    ...
    "-in", r"D:\TER_GRIMMER\Methodologie\traitements\classif\app_distr_homo\typo_wtht_others\buech_classif\classif_10_bis\indices\buech_zoi4_bis.tif",
    "-channel", "2",
    "-parameters.xrad", "3",
    "-parameters.yrad", "3",
    "-texture", "simple",
    "-out", r"D:\TER_GRIMMER\Methodologie\traitements\classif\app_distr_homo\typo_wtht_others\buech_classif\classif_10_bis\indices\buech_zoi4_bis_texture.tif"
]
...
def classify_correct_vectorize(raster_path, model_path, output_corrected_path, output_shapefile, value_to_keep=1, min_size=400):
    ...
    # Empiler les bandes pour obtenir une matrice 3D
    stacked_bands = np.stack((band1, band2, band3, band4, band5, band6), axis=2)
    ...
    # Correction par analyse en composante connexe
    def segment_components(image):
        all_labels = np.zeros_like(image, dtype=int)
        current_label = 1
        for value in range(1, 5):  # Les valeurs de pixels vont de 1 à 4
...
raster_path = r"D:\TER_GRIMMER\Methodologie\traitements\classif\app_distr_homo\typo_wtht_others\buech_classif\classif_9\buech_zoi1_band_ndvi_homred_brightness.tif"
model_path = r"D:\TER_GRIMMER\Methodologie\traitements\classif\app_distr_homo\typo_wtht_others\classif_9_band_ndvi_homred_brightness_wtht_others\classif_model_9.rf"
output_corrected_path = r"D:\TER_GRIMMER\Methodologie\traitements\classif\app_distr_homo\typo_wtht_others\buech_classif\classif_9\buech_zoi1_test_outil.tif"
output_shapefile = r"D:\TER_GRIMMER\Methodologie\traitements\classif\app_distr_homo\typo_wtht_others\buech_classif\classif_9\buech_zoi1_test_outil.shp"

classify_correct_vectorize(raster_path, model_path, output_corrected_path, output_shapefile)
